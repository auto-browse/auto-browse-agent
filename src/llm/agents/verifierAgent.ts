...
export async function createVerifierAgent() {
   ...
   const verifierPrompt = `You are a plan execution verifier. Your job is to analyze if a planned action was successfully executed based on the result and current browser state.
...
9. Always Call the browser_state tool to get the current state of the webpage and use it to inform your verification.
